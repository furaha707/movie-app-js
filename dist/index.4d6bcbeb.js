...
class App extends (0, _heropy.Component) {
    render() {
        ...
        this.el.append(theHeader, routerView, new (0, _theFooterDefault.default)().el);
    }
}
exports.default = App;
...
function routeRender(routes) {
    ...
    if (routerView) {
        ...
        if (currentRoute) routerView.append(new currentRoute.component().el);
    }
    // 3) 화면 출력 후 스크롤 위치 복구
    window.scrollTo(0, 0);
}
...
class Store {
    ...
    subscribe(key, cb) {
        if (Array.isArray(this.observers[key])) this.observers[key].push(cb);
        else this.observers[key] = [
            cb
        ];
    }
}
...
class MovieListMore extends (0, _heropy.Component) {
    constructor(){
        ...
        (0, _movieDefault.default).subscribe("pageMax", ()=>{
            ...
            pageMax > page ? this.el.classList.add("hide") : this.el.classList.remove("hide");
        });
    }
    render() {
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f3BSW","gLLPy"], "gLLPy", "parcelRequire07ea")
